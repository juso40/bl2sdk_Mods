...
class _BeginEndDragDropSource(object):
    ...
    def __enter__(self): # real signature unknown; restored from __doc__
        """ _BeginEndDragDropSource.__enter__(self) """
        pass
    ...
    def __exit__(self, exc_type, exc_val, exc_tb): # real signature unknown; restored from __doc__
        """ _BeginEndDragDropSource.__exit__(self, exc_type, exc_val, exc_tb) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _BeginEndDragDropSource.__reduce_cython__(self) """
        pass
    ...
    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _BeginEndDragDropSource.__setstate_cython__(self, __pyx_state) """
        pass
