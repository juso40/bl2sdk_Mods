...
class _DrawCmd(object):
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _DrawCmd.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _DrawCmd.__setstate_cython__(self, __pyx_state) """
        pass

    clip_rect = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    elem_count = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    texture_id = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x03CCE7E8>'
