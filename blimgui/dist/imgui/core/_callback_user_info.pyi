...
class _callback_user_info(object):
    """ _callback_user_info() """
    def populate(self, callback_fn, user_data): # real signature unknown; restored from __doc__
        """ _callback_user_info.populate(self, callback_fn, user_data) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _callback_user_info.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _callback_user_info.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x03CCEB00>'
