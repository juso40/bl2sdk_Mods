...
class _Colors(object):
    ...
    def __init__(self, GuiStyle_gui_style): # real signature unknown; restored from __doc__
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _Colors.__reduce_cython__(self) """
        pass
    ...
    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _Colors.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x03CCE908>'
