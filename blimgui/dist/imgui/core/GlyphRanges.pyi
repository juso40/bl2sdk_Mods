...
class GlyphRanges(object):
    ...
    def __del__(self): # real signature unknown; restored from __doc__
        """ GlyphRanges.__del__(self) """
        pass

    def __init__(self, glyph_ranges): # real signature unknown; restored from __doc__
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ GlyphRanges.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ GlyphRanges.__setstate_cython__(self, __pyx_state) """
        pass
